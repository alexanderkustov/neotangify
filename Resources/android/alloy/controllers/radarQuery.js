function Controller() {
    ...
    $.__views.__alloyId34.titleControl = $.__views.myTitleLabel;
    ...
    geolocate ? $.__views.__alloyId37.addEventListener("click", geolocate) : __defers["$.__views.__alloyId37!click!geolocate"] = true;
    ...
    $.__views.__alloyId36.add($.__views.age);
    ...
    $.__views.__alloyId36.add($.__views.radar);
    ...
    __defers["$.__views.__alloyId37!click!geolocate"] && $.__views.__alloyId37.addEventListener("click", geolocate);
    _.extend($, exports);
}
