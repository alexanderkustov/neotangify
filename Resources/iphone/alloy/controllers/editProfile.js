function Controller() {
    ...
    $.__views.__alloyId11.leftNavButton = $.__views.back;
    ...
    uploadCoverPic ? $.__views.__alloyId14.addEventListener("click", uploadCoverPic) : __defers["$.__views.__alloyId14!click!uploadCoverPic"] = true;
    ...
    uploadPic ? $.__views.__alloyId15.addEventListener("click", uploadPic) : __defers["$.__views.__alloyId15!click!uploadPic"] = true;
    ...
    $.__views.__alloyId13.add($.__views.email);
    ...
    $.__views.__alloyId13.add($.__views.password_confirmation);
