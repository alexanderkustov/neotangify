function Controller() {
    ...
    $.__views.mainLogin.add($.__views.__alloyId31);
    facebookLogin ? $.__views.__alloyId31.addEventListener("click", facebookLogin) : __defers["$.__views.__alloyId31!click!facebookLogin"] = true;
