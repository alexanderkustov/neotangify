function Controller() {
    ...
    $.__views.__alloyId27.add($.__views.loginInput);
    ...
    openRegister ? $.__views.__alloyId31.addEventListener("click", openRegister) : __defers["$.__views.__alloyId31!click!openRegister"] = true;
