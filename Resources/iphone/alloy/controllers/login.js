function Controller() {
    ...
    $.__views.__alloyId19.add($.__views.loginInput);
    ...
    facelogin ? $.__views.__alloyId22.addEventListener("click", facelogin) : __defers["$.__views.__alloyId22!click!facelogin"] = true;
    ...
    openRegister ? $.__views.__alloyId23.addEventListener("click", openRegister) : __defers["$.__views.__alloyId23!click!openRegister"] = true;
    ...
    __defers["$.__views.__alloyId22!click!facelogin"] && $.__views.__alloyId22.addEventListener("click", facelogin);
    __defers["$.__views.__alloyId23!click!openRegister"] && $.__views.__alloyId23.addEventListener("click", openRegister);
    _.extend($, exports);
}
