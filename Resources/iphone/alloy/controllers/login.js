function Controller() {
    ...
    $.__views.__alloyId22.add($.__views.login);
    ...
    $.__views.__alloyId22.add($.__views.password);
    ...
    login ? $.__views.__alloyId24.addEventListener("click", login) : __defers["$.__views.__alloyId24!click!login"] = true;
