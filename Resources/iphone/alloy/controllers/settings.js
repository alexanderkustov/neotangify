...
function Controller() {
    ...
    $.__views.settings.add($.__views.__alloyId19);
    ...
    $.__views.__alloyId19.add($.__views.basicSwitch);
    ...
    uploadCoverPic ? $.__views.__alloyId21.addEventListener("click", uploadCoverPic) : __defers["$.__views.__alloyId21!click!uploadCoverPic"] = true;
    ...
    uploadPic ? $.__views.__alloyId22.addEventListener("click", uploadPic) : __defers["$.__views.__alloyId22!click!uploadPic"] = true;
    ...
    $.__views.__alloyId19.add($.__views.short_description);
    ...
    __defers["$.__views.__alloyId21!click!uploadCoverPic"] && $.__views.__alloyId21.addEventListener("click", uploadCoverPic);
    __defers["$.__views.__alloyId22!click!uploadPic"] && $.__views.__alloyId22.addEventListener("click", uploadPic);
