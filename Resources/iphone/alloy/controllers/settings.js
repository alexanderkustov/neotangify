function Controller() {
    ...
    logout ? $.__views.__alloyId46.addEventListener("click", logout) : __defers["$.__views.__alloyId46!click!logout"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId46!click!logout"] && $.__views.__alloyId46.addEventListener("click", logout);
    _.extend($, exports);
}
