function Controller() {
    ...
    sendMsg ? $.__views.__alloyId34.addEventListener("click", sendMsg) : __defers["$.__views.__alloyId34!click!sendMsg"] = true;
    ...
    addFriend ? $.__views.__alloyId35.addEventListener("click", addFriend) : __defers["$.__views.__alloyId35!click!addFriend"] = true;
