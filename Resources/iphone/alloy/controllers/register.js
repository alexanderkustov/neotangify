function Controller() {
    ...
    $.__views.__alloyId33.leftNavButton = $.__views.back;
    ...
    register ? $.__views.__alloyId36.addEventListener("click", register) : __defers["$.__views.__alloyId36!click!register"] = true;
    ...
    __defers["$.__views.__alloyId36!click!register"] && $.__views.__alloyId36.addEventListener("click", register);
    _.extend($, exports);
}
