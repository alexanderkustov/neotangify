function Controller() {
    ...
    $.__views.__alloyId29.leftNavButton = $.__views.back;
    ...
    takePicture ? $.__views.__alloyId32.addEventListener("click", takePicture) : __defers["$.__views.__alloyId32!click!takePicture"] = true;
    ...
    $.__views.__alloyId31.add($.__views.name);
    ...
    $.__views.__alloyId31.add($.__views.short_description);
    ...
    $.__views.__alloyId31.add($.__views.password);
    ...
    $.__views.__alloyId31.add($.__views.password_confirmation);
    ...
    editProfile ? $.__views.__alloyId34.addEventListener("click", editProfile) : __defers["$.__views.__alloyId34!click!editProfile"] = true;
    ...
    __defers["$.__views.__alloyId32!click!takePicture"] && $.__views.__alloyId32.addEventListener("click", takePicture);
    __defers["$.__views.__alloyId34!click!editProfile"] && $.__views.__alloyId34.addEventListener("click", editProfile);
    _.extend($, exports);
}
