function Controller() {
    ...
    $.__views.__alloyId30.leftNavButton = $.__views.back;
    ...
    takePicture ? $.__views.__alloyId33.addEventListener("click", takePicture) : __defers["$.__views.__alloyId33!click!takePicture"] = true;
    ...
    $.__views.__alloyId32.add($.__views.email);
    ...
    $.__views.__alloyId32.add($.__views.password);
    ...
    $.__views.__alloyId32.add($.__views.password_confirmation);
    ...
    editProfile ? $.__views.__alloyId35.addEventListener("click", editProfile) : __defers["$.__views.__alloyId35!click!editProfile"] = true;
    ...
    __defers["$.__views.__alloyId33!click!takePicture"] && $.__views.__alloyId33.addEventListener("click", takePicture);
    __defers["$.__views.__alloyId35!click!editProfile"] && $.__views.__alloyId35.addEventListener("click", editProfile);
    _.extend($, exports);
}
